...
declare global {
  ...
  const useNoiseSuppression: typeof import('../../composables/useNoiseSuppression').useNoiseSuppression
...
declare global {
  ...
  // @ts-ignore
  export type { ProductConfig, AppConfig, VoicevoxSpeakerOption, LlmModelOption, TtsSpeakerOption, TtsLanguageOption, TtsVoiceOption } from '../../composables/useAppSettings'
  import('../../composables/useAppSettings')
  // @ts-ignore
  export type { SessionState, ConversationMessage } from '../../composables/useSession'
  import('../../composables/useSession')
}
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly useNoiseSuppression: UnwrapRef<typeof import('../../composables/useNoiseSuppression')['useNoiseSuppression']>
